...
feature "visitor sees list of reviews on restaurant page" do
  ...
  scenario "does not see other reviews for other restaurants" do
    ...
    review_for_dumplings = Review.create(rating: 3, body: "The pork and leek is my favorite as I think it's a bit juicier than the other options", restaurant: dumpling_king)
